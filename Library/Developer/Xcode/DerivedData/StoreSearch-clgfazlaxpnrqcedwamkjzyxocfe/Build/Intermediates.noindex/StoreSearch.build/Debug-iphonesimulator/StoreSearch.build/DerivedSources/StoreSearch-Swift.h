...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StoreSearch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11StoreSearch11AppDelegate")
...
SWIFT_CLASS("_TtC11StoreSearch16SearchResultCell")
...
SWIFT_CLASS("_TtC11StoreSearch20SearchViewController")
...
- (void)viewDidLoad;
- (IBAction)segmentChanged:(UISegmentedControl * _Nonnull)sender;
...
@interface SearchViewController (SWIFT_EXTENSION(StoreSearch)) <UISearchBarDelegate>
- (UIBarPosition)positionForBar:(id <UIBarPositioning> _Nonnull)bar SWIFT_WARN_UNUSED_RESULT;
- (void)searchBarSearchButtonClicked:(UISearchBar * _Nonnull)searchBar;
@end


@interface SearchViewController (SWIFT_EXTENSION(StoreSearch)) <UITableViewDataSource, UITableViewDelegate>
