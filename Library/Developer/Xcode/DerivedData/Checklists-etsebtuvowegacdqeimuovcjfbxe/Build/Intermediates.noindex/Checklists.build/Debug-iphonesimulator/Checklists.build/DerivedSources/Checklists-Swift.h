...
SWIFT_CLASS("_TtC10Checklists22AllListsViewController")
@interface AllListsViewController : UITableViewController <UINavigationControllerDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC10Checklists9Checklist")
...
SWIFT_CLASS("_TtC10Checklists13ChecklistItem")
...
SWIFT_CLASS("_TtC10Checklists24IconPickerViewController")
...
SWIFT_CLASS("_TtC10Checklists24ItemDetailViewController")
...
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified shouldRemindSwitch;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified dueDateLabel;
@property (nonatomic, weak) IBOutlet UITableViewCell * _Null_unspecified datePickerCell;
@property (nonatomic, weak) IBOutlet UIDatePicker * _Null_unspecified datePicker;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)cancel;
- (IBAction)done;
- (IBAction)shouldRemindToggled:(UISwitch * _Nonnull)switchControl;
- (IBAction)dateChanged:(UIDatePicker * _Nonnull)datePicker;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC10Checklists24ListDetailViewController")
